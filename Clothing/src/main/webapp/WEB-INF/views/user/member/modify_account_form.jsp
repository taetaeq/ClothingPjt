			...
			<div class="modify_account_form">
				<form action="<c:url value='/user/member/modifyAccountConfirm' />"
					...
					<input type="hidden" name="userId"
						value="${loginedUserMemberVo.userId}"> 
						<input type="text"
						name="username" value="${loginedUserMemberVo.username}" readonly
						disabled> <br> 
						
						<input type="password" name="password" placeholder="새 비밀번호를 입력하세요."> <br>
						
						<input type="text" name="name" value="${loginedUserMemberVo.name}"
						placeholder="사용자 이름을 입력하세요."> <br> 
					...
					<input type="email" name="email" value="${loginedUserMemberVo.email}" placeholder="사용자 이메일을 입력하세요."><br>
					
					<input type="text" name="phone" value="${loginedUserMemberVo.phone}" placeholder="사용자 전화번호를 입력하세요."> <br> 
					
					<input type="button" value="회원 정보 수정" onclick="modifyAccountForm();">
